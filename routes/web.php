...
Route::get('/admin/users/login/fgpassword',[LoginController::class, 'fgpassword'])->name('forpw');
Route::post('/admin/users/login/rcvpassword',[LoginController::class, 'rcvpassword']);
